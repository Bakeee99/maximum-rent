...
export default async function AdminPage({
  ...
  const input =
    "h-10 w-full rounded-xl border border-border bg-background px-3 text-sm outline-none transition-colors focus:border-brand focus:ring-2 focus:ring-ring/30";
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
      ...
      >
        ...
        <input type="date" name="from" required min={today} className={input} />
        <input type="date" name="to" required min={today} className={input} />
        <input
          type="text"
          name="reason"
        ...
        <button
          type="submit"
          className="inline-flex h-10 items-center justify-center gap-1.5 rounded-xl bg-brand px-4 text-sm font-semibold text-brand-foreground transition-colors hover:bg-brand-700"
        >
